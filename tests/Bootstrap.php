 ...
 * http://github.com/padraic/packman/master/LICENSE
 ...
 * @license    http://github.com/padraic/packman/master/LICENSE New BSD License
 */
...
/*
 * Prepend the Packman library/ and tests/ directories to the
...
if (defined('TESTS_GENERATE_REPORT') && TESTS_GENERATE_REPORT === true &&
    ...
    /*
     * Add Packman library/ directory to the PHPUnit code coverage
...
require_once 'Packman/Loader.php';
$loader = new \Packman\Loader;
$loader->register();
